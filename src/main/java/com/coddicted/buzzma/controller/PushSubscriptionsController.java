...
import com.coddicted.buzzma.service.PushSubscriptionsService;
...
@RestController
@Validated
@RequestMapping("/api/push_subscriptions")
public class PushSubscriptionsController {
  private final PushSubscriptionsService service;

  public PushSubscriptionsController(final PushSubscriptionsService service) {
  ...
  @GetMapping("/{id}")
  public PushSubscriptionsResponseDto getById(@PathVariable final UUID id) {
    return service.getById(id);
  }

  @PostMapping
  public PushSubscriptionsResponseDto create(
      @RequestBody @Valid final PushSubscriptionsRequestDto request) {
    return service.create(request);
  }

  @PatchMapping("/{id}")
  public PushSubscriptionsResponseDto update(
      @PathVariable final UUID id, @RequestBody @Valid final PushSubscriptionsRequestDto request) {
