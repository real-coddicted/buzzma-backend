...
import com.coddicted.buzzma.service.TicketsService;
...
public class TicketsController {
  ...
  @GetMapping("/{id}")
  public TicketsResponseDto getById(@PathVariable final UUID id) {
    return service.getById(id);
  }

  @PostMapping
  public TicketsResponseDto create(@RequestBody @Valid final TicketsRequestDto request) {
    return service.create(request);
  }

  @PatchMapping("/{id}")
  public TicketsResponseDto update(
      @PathVariable final UUID id, @RequestBody @Valid final TicketsRequestDto request) {
