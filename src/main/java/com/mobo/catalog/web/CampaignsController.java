...
public class CampaignsController {
  ...
  @GetMapping("/{id}")
  public CampaignsResponseDto getById(@PathVariable UUID id) {
    return service.getById(id);
  }

  @PostMapping
  @ResponseStatus(HttpStatus.CREATED)
  public CampaignsResponseDto create(@Valid @RequestBody CampaignsRequestDto request) {
    return service.create(request);
  }

  @PatchMapping("/{id}")
  public CampaignsResponseDto update(
      @PathVariable UUID id, @Valid @RequestBody CampaignsRequestDto request) {
